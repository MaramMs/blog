...
const ContactUs = () => {
  return (
    <div className="bg-[#F8F8F8] p-[24px]  mx-auto  shadow-md mt-[32px] w-[926px] rounded-[8px]">
      <form className="w-[878px] flex flex-col gap-[32px]">
<div className="flex flex-col gap-[8px]">
        ...
        <textarea   placeholder="موضوع الرسالة"          
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-[4px]">
              <p className="font-medium text-[16px] text-[#1B2532] m-0">راسلنا و تابعنا عبر:</p>
...
<CiFacebook className="text-[#DD3B4A] text-[20px]"/>
            ...
            <p className="text-[#1B2532] font-medium text-[16px]">للاستفسارات العامة أو الدعم الفني: 
